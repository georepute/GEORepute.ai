...
export async function GET(request: NextRequest) {
  try {
    ...
    const redirectUri = `${process.env.NEXT_PUBLIC_SITE_URL || request.nextUrl.origin}/api/integrations/google-business-profile/callback?return_to=${encodeURIComponent(returnTo)}`;
