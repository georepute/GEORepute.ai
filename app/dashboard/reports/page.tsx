...
export default function Reports() {
  const { isRtl, t, language: dashboardLanguage } = useLanguage();
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      pdf.addPage();
      appendMandatoryCompliancePdfSection(pdf, {
        margin,
        pageWidth,
        contentTop: margin + 8,
        contentBottom: pageHeight - 8,
        locale: dashboardLanguage === "he" ? "he" : "en",
  ...
  const handleExportSheet = () => {
    ...
    const csvData = [
      ...
      [""],
      [
        `=== ${getMethodologyDisclaimerTitle(dashboardLanguage === "he" ? "he" : "en")} ===`,
      ],
      [getDisclaimerText(dashboardLanguage === "he" ? "he" : "en")],
      [""],
