...
export function BrandAnalysisProjectCard({ project }: BrandAnalysisProjectCardProps) {
  ...
  return (
    <Card className="hover:shadow-md transition-all duration-200 w-full overflow-hidden border-l-4 border-primary/70">
      <CardHeader className="pb-2 p-3 sm:p-4 md:p-5">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              <CardTitle className="text-sm sm:text-base md:text-lg truncate flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => navigate(`/dashboard/brand-analysis/project/${project.id}`)}>
      ...
      <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4 md:p-5 pt-0">
        {/* Stats */}
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-1">
          <Button size="sm" className="flex-1 text-xs sm:text-sm h-8 sm:h-9" onClick={() => navigate(`/dashboard/brand-analysis/project/${project.id}`)}>
