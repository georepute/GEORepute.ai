...
export default function BrandAnalysisIndex() {
  ...
  return (
    <DashboardLayout>
      <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-x-hidden">
        ...
        <div className="flex flex-col gap-4 bg-white dark:bg-gray-900 rounded-lg p-4 sm:p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold text-foreground">Brand Visibility</h1>
        ...
        {/* Stats Overview - Redesigned with better visuals */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              ...
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-baseline gap-1 mt-1">
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground">{totalMentions}</p>
                    <p className="text-xs text-muted-foreground hidden sm:block">across all brands</p>
                  </div>
                  <p className="text-xs text-muted-foreground sm:hidden">across all brands</p>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Search className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-primary" />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-baseline gap-1 mt-1">
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground">{activePlatforms}</p>
                    <p className="text-xs text-muted-foreground hidden sm:block">active platforms</p>
                  </div>
                  <p className="text-xs text-muted-foreground sm:hidden">active platforms</p>
                </div>
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-accent/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Target className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-accent" />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-baseline gap-1 mt-1">
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground">{avgVisibility}%</p>
                    <p className="text-xs text-muted-foreground hidden sm:block">mention rate</p>
                  </div>
                  <p className="text-xs text-muted-foreground sm:hidden">mention rate</p>
                </div>
                <div className="w-10 h-10 md:w-12 md:h-12 bg-secondary/10 rounded-lg flex items-center justify-center">
                  <Eye className="w-5 h-5 md:w-6 md:h-6 text-secondary" />
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden border-l-4 border-destructive">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-medium text-muted-foreground">Avg Sentiment</p>
                  <div className="flex items-baseline gap-1 mt-1">
                    <p className="text-2xl md:text-3xl font-bold text-foreground">{stats?.avgSentiment || 0}%</p>
                    {stats?.recentTrend && (
                ...
                <div className="w-10 h-10 md:w-12 md:h-12 bg-destructive/10 rounded-lg flex items-center justify-center">
                  <BarChart3 className="w-5 h-5 md:w-6 md:h-6 text-destructive" />
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {/* Main Content */}
        {projects.length === 0 ? (
          /* Empty State - Redesigned to be more engaging */
          <Card className="text-center py-8 md:py-12 border border-dashed">
            <CardContent className="px-4 md:px-6 max-w-2xl mx-auto">
          ...
          /* Projects Grid - Redesigned with better spacing and organization */
          <div className="space-y-5">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white dark:bg-gray-900 rounded-lg p-4 shadow-sm">
        ...
        {/* Info Banner - Redesigned to be more visually appealing */}
