-- ============================================================================
-- Add WordPress Platform Support (WordPress.com + Self-Hosted)
-- ============================================================================
-- This migration adds WordPress platforms to the allowed platforms in:
-- 1. platform_integrations table
-- 2. content_strategy table
-- 3. published_content table
-- 
-- Supports:
--   - 'wordpress' = WordPress.com (OAuth)
--   - 'wordpress_self_hosted' = Self-hosted WordPress (Application Passwords)
--
-- Run this after 013_add_shopify_platform.sql
-- ============================================================================
...
-- STEP 1.2: Add updated constraint with WordPress (both types) included
...
COMMENT ON COLUMN platform_integrations.platform IS 'Platform identifier. Supported: google_search_console, google_analytics, google_business_profile, google_ads, facebook, linkedin, instagram, github, medium, quora, reddit, shopify, wordpress (WordPress.com), wordpress_self_hosted (Self-hosted WordPress)';
...
-- STEP 2.2: Add updated constraint with WordPress (both types) included
ALTER TABLE content_strategy 
...
-- STEP 3.2: Add updated constraint with WordPress (both types) included
ALTER TABLE published_content 
