  ...
  if (language === 'he') {
    return {
      ...
      deadGiveaway: {
        ...
        "ניתן לראות ש": ["ברור ש", "אפשר לראות ש"],
        "חשוב לזכור ש": ["כדאי לזכור ש", "צריך לזכור ש"],
        "בהקשר זה": ["כאן", "בעניין הזה"],
        "כפי שצוין": ["כפי שנאמר", "כפי שהוזכר"],
        "באופן משמעותי": ["מאוד", "בצורה ניכרת"],
        "בסופו של דבר": ["בסוף", "בסיכומו של דבר"],
        "ללא ספק": ["ברור", "ודאי"],
      ...
      highFrequency: {
        ...
        "בהתאם": ["לפי", "בהתאם ל", "לפי זה"],
        "בהקשר זה": ["כאן", "בעניין הזה", ""],
        "במסגרת": ["ב", "בתוך", "בתחום"],
        "באופן כללי": ["בכלל", "בדרך כלל", "רוב הזמן"],
        "באופן טבעי": ["טבעי ש", "ברור ש", ""],
        "על מנת": ["כדי", "ל"],
        "בשל העובדה ש": ["כי", "משום ש"],
        "למרות העובדה ש": ["למרות ש", "אף ש"]
      },
      // Phrases to completely remove in Hebrew (filler + robotic patterns)
      removePhrases: [
        ...
        "ניתן לראות ש", "חשוב לזכור ש", "יש לזכור ש",
        "בהקשר זה", "במסגרת זו", "בנושא זה",
        "כאמור", "כפי שצוין", "כפי שציין",
        "על פני השטח", "בפועל", "במציאות",
        "באופן משמעותי", "במידה ניכרת",
        "מעבר לכך", "מעבר לזה", "יתרה מכך",
        "בסופו של דבר", "במבט ראשון", "ללא ספק"
      ],
